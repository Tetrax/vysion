...
describe('Vysion audit tracer', () => {
  it('uploads one configuration and renders compact typed findings with exports', async () => {
    ...
    expect(screen.getByRole('link', { name: 'JSON' })).toHaveAttribute('href', '/api/reports/7bd449c4-ef96-4d72-b4f6-2bc099c982a2.json')
    expect(screen.getByRole('link', { name: 'DOCX' })).toHaveAttribute('href', '/api/reports/7bd449c4-ef96-4d72-b4f6-2bc099c982a2.docx')
    expect(screen.getByRole('link', { name: 'XLSX' })).toHaveAttribute('href', '/api/reports/7bd449c4-ef96-4d72-b4f6-2bc099c982a2.xlsx')
  })
